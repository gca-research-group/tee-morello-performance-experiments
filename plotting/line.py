...
axs[0, 0].plot(df_in_means.index, df_in_means['Allocation Time (ms)'], label='Inside Compartment - purecap ABI', marker='o', linestyle='-')
axs[0, 0].plot(df_out_means.index, df_out_means['Allocation Time (ms)'], label='Outside Compartment', marker='s', linestyle='--')
axs[0, 0].plot(df_benchmark_means.index, df_benchmark_means['Allocation Time (ms)'], label='Inside Compartment - purecap-benchmark ABI', marker='^', linestyle=':')
...
# Plot Write Time
axs[0, 1].plot(df_in_means.index, df_in_means['Write Time (ms)'], label='Inside Compartment - purecap ABI,', marker='o', linestyle='-')
axs[0, 1].plot(df_out_means.index, df_out_means['Write Time (ms)'], label='Outside Compartment', marker='s', linestyle='--')
axs[0, 1].plot(df_benchmark_means.index, df_benchmark_means['Write Time (ms)'], label='Inside Compartment - purecap-benchmark ABI', marker='^', linestyle=':')
...
# Plot Read Time
axs[1, 0].plot(df_in_means.index, df_in_means['Read Time (ms)'], label='Inside Compartment - purecap ABI', marker='o', linestyle='-')
axs[1, 0].plot(df_out_means.index, df_out_means['Read Time (ms)'], label='Outside Compartment', marker='s', linestyle='--')
axs[1, 0].plot(df_benchmark_means.index, df_benchmark_means['Read Time (ms)'], label='Inside Compartment - purecap-benchmark ABI', marker='^', linestyle=':')
...
# Plot Free Time
axs[1, 1].plot(df_in_means.index, df_in_means['Free Time (ms)'], label='Inside Compartment - purecap ABI', marker='o', linestyle='-')
axs[1, 1].plot(df_out_means.index, df_out_means['Free Time (ms)'], label='Outside Compartment', marker='s', linestyle='--')
axs[1, 1].plot(df_benchmark_means.index, df_benchmark_means['Free Time (ms)'], label='Inside Compartment - purecap-benchmark ABI', marker='^', linestyle=':')
